...
class OrderItemInline(admin.TabularInline):
    model = OrderItem
    extra = 0
    fields = ('image_preview', 'product', 'quantity', 'size', 'get_total_price')
    ...
    def get_total_price(self, obj):
        try:
            ...
            return mark_safe(f'<span style="color: gray;">Invalid data</span>')
...
class OrderAdmin(admin.ModelAdmin):
    ...
    def get_readonly_fields(self, request, obj=None):
        if obj:
            return self.readonly_fields + ('user', 'email', 'first_name', 'last_name', 'company', 'address1', 'address2', 'city', 'country', 'province', 'postal_code', 'phone', 'special_instructions', 'total_price',)
